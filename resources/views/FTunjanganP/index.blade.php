                      ...
                      <tbody>
                         ...
                         @foreach ($tp as $data)
                             <tr>
                                 ...
                                 <th><a href="{{url('TunjanganP',$data->id)}}" class="btn btn-primary"><i class="fa fa-eye"></i></a></th>
                                 <th><a title="Edit" href="{{route('TunjanganP.edit',$data->id)}}" class="btn btn-warning"><i class="fa fa-edit"></i></a></th>
                                 <th>
